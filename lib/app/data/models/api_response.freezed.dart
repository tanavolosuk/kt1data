...
class __$$FailedImplCopyWithImpl<T, $Res>
    extends _$ApiResponseCopyWithImpl<T, $Res, _$FailedImpl<T>>
...
class _$FailedImpl<T> implements _Failed<T> {
  ...
  @override
  String toString() {
    return 'ApiResponse<$T>.failed(message: $message)';
  }
...
abstract class _Failed<T> implements ApiResponse<T> {
  factory _Failed(final String message) = _$FailedImpl<T>;
